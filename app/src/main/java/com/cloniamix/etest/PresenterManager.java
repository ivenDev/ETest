...
public  class PresenterManager {
    ...
    private final  Cache<Long,MainPresenter > presenters;
   ...
   /* public <P extends MainPresenter > P restorePresenter(Bundle savedInstanceState){
    ...
    public void savePresenter(MainPresenter presenter, Bundle outState){
